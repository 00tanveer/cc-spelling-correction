...
# O(n*m) where n is the number of edits and m is the number of words in the dataframe
...
if spellcheck_word in df['word'].values:
    ...
    #     if edit in df['word'].values:
    #         print("transposition edits:", edit)
    #         words.append(edit)
    # for edit in deletion(spellcheck_word):
    #     if edit in df['word'].values:
    #         print("deletion edits:", edit)
    #         words.append(edit)
    # print("All suggested edits:", set(words))
...
words_df = df[df['word'].isin(lookup_suggetions(spellcheck_word))].sort_values(
